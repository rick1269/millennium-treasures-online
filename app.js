...
main.addEventListener('input',e=>{if(e.target.matches('.auth-form [name="email"]'))authEmail=e.target.value;if(e.target.closest('.auth-form')&&authFeedback?.type==='error')setAuthFeedback(null);if(e.target.id==='firstMode')selectedFirstMode=e.target.value;if(e.target.id==='direction')selectedDirection=Number(e.target.value);});
main.addEventListener('change',e=>{if(e.target.id==='firstMode')selectedFirstMode=e.target.value;if(e.target.id==='direction')selectedDirection=Number(e.target.value);});
